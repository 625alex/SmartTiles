...
function animateClick(e){spinner(e),e.closest(".tile").animate({opacity:.3},fadeOff,"swing").delay(fadeOn).animate({opacity:1},fadeOn,"swing")}function spinner(e){e.closest(".tile").find(".spinner").fadeIn("slow").delay(2e3).fadeOut("slow")}function setIcons(){$(".switch").append("<div class='icon'>"+icons["switch"].on+icons["switch"].off+"</div>"),$(".dimmer").append("<div class='icon'>"+icons.dimmer.on+icons.dimmer.off+"</div>"),$(".light").append("<div class='icon'>"+icons.light.on+icons.light.off+"</div>"),$(".dimmerLight").append("<div class='icon'>"+icons.light.on+icons.light.off+"</div>"),$(".themeLight").append("<div class='icon'>"+icons.themeLight.on+icons.themeLight.off+"</div>"),$(".lock").append("<div class='icon'>"+icons.lock.locked+icons.lock.unlocked+"</div>"),$(".motion").append("<div class='icon'>"+icons.motion.active+icons.motion.inactive+"</div>"),$(".presence").append("<div class='icon'>"+icons.presence.present+icons.presence.notPresent+"</div>"),$(".contact").append("<div class='icon'>"+icons.contact.open+icons.contact.closed+"</div>"),$(".water").append("<div class='icon'>"+icons.water.dry+icons.water.wet+"</div>"),$(".dimmer, .dimmerLight, .music").each(function(){renderSlider($(this))}),$(".weather").each(function(){renderWeather($(this))}),$(".momentary").append("<div class='icon'>"+icons.momentary+"</div>"),$(".camera").append("<div class='icon'>"+icons.camera+"</div>"),$(".refresh").append("<div class='icon'>"+icons.refresh+"</div>"),$(".hello-home").append("<div class='icon'>"+icons.helloHome+"</div>"),$(".humidity").append("<div class='footer'>"+icons.humidity+"</div>"),$(".temperature").append("<div class='footer'>"+icons.temperature+"</div>"),$(".energy").append("<div class='footer'>"+icons.energy+"</div>"),$(".power").append("<div class='footer'>"+icons.power+"</div>"),$(".battery").append("<div class='footer'>"+icons.battery+"</div>"),$(".link").find("a").html(icons.link),$(".dashboard").find("a").html(icons.dashboard),$(".tile[data-is-value=true]").each(function(){renderValue($(this))})}function renderSlider(e){e.find(".slider-container").remove(),e.append("<div class='slider-container'><div class='full-width-slider'><input value='"+e.attr("data-level")+"' min='1' max='10' type='range' step='1' data-mini='true' data-popup-enabled='true' data-disabled='"+readOnlyMode+"' data-highlight='true'></div></div>").find("input").slider(),$(".full-width-slider").click(function(e){e.stopImmediatePropagation()})}function renderValue(e){e.find(".icon").remove(),e.append("<div class='icon text'>"+e.attr("data-value")+"</div>")}function renderWeather(e){var t=JSON.parse(e.attr("data-weather"));e.empty();var i="<div class='title'>"+e.attr("data-city")+"<br/><span class='title2'>"+t.weather+", feels like "+t.feelsLike+"&deg;</span></div>\n<div class='icon'><span class='text'>"+t.temperature+"&deg;</span><i class='wi "+t.icon+"'></i></span></div>\n<div class='footer'>"+t.localSunrise+" <i class='fa fa-fw wi wi-horizon-alt'></i> "+t.localSunset+"</div>\n<div class='footer right'>"+t.percentPrecip+"%<i class='fa fa-fw fa-umbrella'></i><br>"+t.humidity+"%<i class='fa fa-fw wi wi-sprinkles'></i></div>";e.html(i)}function sendCommand(e,t,i,a){var n=getUrlParameter("access_token"),o={type:e,device:t,command:i,value:a};n&&(o.access_token=n),$.get("command",o).done(function(e){"ok"==e.status&&nextPoll(5)}).fail(function(){setWTFCloud(),nextPoll(10)})}function doPoll(e){nextPoll(20),e||spinner($(".refresh"));var t=getUrlParameter("access_token"),a={ts:stateTS};t&&(a.access_token=t),$.get("ping",a).done(function(t){if("refresh"==t.status&&refresh(),clearWTFCloud(),e)e();else if(stateTS=t.ts,$(".refresh .footer").html("Updated "+t.updated),"update"==t.status)for(i in t.data)updateTile(t.data[i])}).fail(function(){setWTFCloud()})}function updateTile(e){if("device"==e.tile){var t=$("."+e.type+"[data-device="+e.device+"]");"music"==e.type&&((e.trackDescription!=t.attr("data-track-description")||e.mute+""!=t.attr("data-mute"))&&spinner(t),t.attr("data-track-description",e.trackDescription),e.mute+""!=t.attr("data-mute")&&t.toggleClass("muted"),t.attr("data-mute",e.mute),t.find(".title .track").html(t.attr("data-track-description"))),"weather"==e.tile?(t.attr("data-weather",JSON.stringify(d)),renderWeather(t)):(e.value!=t.attr("data-value")&&spinner(t),t.attr("data-value",e.value),e.isValue?renderValue(t):(t.removeClass("inactive active").addClass(e.active),t.attr("data-active",e.active)),("dimmer"==e.type||"dimmerLight"==e.type||"music"==e.type)&&(e.level!=t.attr("data-level")&&spinner(t),t.attr("data-level",e.level),renderSlider(t)))}else if("mode"==e.tile){var t=$(".mode");e.mode!=t.attr("data-mode")&&spinner(t),t.removeClass(t.attr("data-mode")),t.attr("data-mode",e.mode),e.isStandardMode&&t.addClass(e.mode),$(".mode-name").html(e.mode)}}function setWTFCloud(){wtfCloud=!0,$("#wtfcloud-popup").popup("open")}function clearWTFCloud(){wtfCloud=!1,$("#wtfcloud-popup").popup("close")}function nextPoll(e){polling&&clearInterval(polling),polling=setInterval(function(){doPoll()},1e3*e)}function refresh(e){e?setTimeout(function(){doRefresh()},1e3*e):setTimeout(function(){doRefresh()},100)}function doRefresh(){$(".refresh .icon").addClass("fa-spin"),doPoll(function(){location.reload()})}function getUrlParameter(e){for(var t=window.location.search.substring(1),i=t.split("&"),a=0;a<i.length;a++){var n=i[a].split("=");if(n[0]==e)return n[1]}}function startTime(){if(document.getElementById("clock")){var e=new Date,t=e.getHours();t>12&&(t-=12);var i=e.getMinutes(),a=e.getSeconds();i=checkTime(i),a=checkTime(a),document.getElementById("clock").innerHTML=t+":"+i,setTimeout(function(){startTime()},500)}}function checkTime(e){return 10>e&&(e="0"+e),e}var scriptVersion="4.6.3";$(function(){return $(".tile").append("<i class='spinner fa fa-refresh fa-spin'></i>"),setIcons(),$(".refresh, .clock").click(function(){refresh()}),startTime(),readOnlyMode?!1:($(".switch, .dimmer, .momentary, .clock, .lock, .link, .themeLight, .camera, .music i, .light, .dimmerLight").click(function(){animateClick($(this))}),$(".dashboard").click(function(e){animateClick($(this)),e.stopImmediatePropagation(),e.preventDefault(),$(".refresh .icon").addClass("fa-spin"),window.location=$(this).find("a").attr("href")}),$(".switch, .light, .lock, .momentary, .themeLight, .camera").click(function(){$(this).closest(".tile").toggleClass("active"),sendCommand($(this).attr("data-type"),$(this).attr("data-device"),"toggle")}),$(".dimmer, .dimmerLight").click(function(){$(this).toggleClass("active"),sendCommand($(this).attr("data-type"),$(this).attr("data-device"),"toggle",$(this).attr("data-level"))}),$(".dimmer, .dimmerLight").on("slidestop",function(){var e=$(this).find("input").val();$(this).hasClass("active")&&(animateClick($(this)),sendCommand($(this).attr("data-type"),$(this).attr("data-device"),"level",e)),$(this).attr("data-level",e)}),$(".music").on("slidestop",function(){var e=$(this).find("input").val();animateClick($(this)),sendCommand("music",$(this).attr("data-device"),"level",e),$(this).attr("data-level",e)}),$(".music .play").click(function(){var e=$(this).closest(".tile");$(this).closest(".tile").toggleClass("active"),sendCommand("music",e.attr("data-device"),"play")}),$(".music .pause").click(function(){var e=$(this).closest(".tile");$(this).closest(".tile").toggleClass("active"),sendCommand("music",e.attr("data-device"),"pause")}),$(".music .muted").click(function(){var e=$(this).closest(".tile");$(this).closest(".tile").toggleClass("muted"),sendCommand("music",e.attr("data-device"),"unmute")}),$(".music .unmuted").click(function(){var e=$(this).closest(".tile");$(this).closest(".tile").toggleClass("muted"),sendCommand("music",e.attr("data-device"),"mute")}),$(".music .back").click(function(){var e=$(this).closest(".tile");sendCommand("music",e.attr("data-device"),"previousTrack")}),$(".music .forward").click(function(){var e=$(this).closest(".tile");sendCommand("music",e.attr("data-device"),"nextTrack")}),$(".mode, .hello-home, .thermostat").click(function(){$("#"+$(this).attr("data-popup")).popup("open")}),$("#mode-popup li").click(function(){$("#mode-popup").popup("close");var e=$(".mode");animateClick(e);var t=$(this).text();sendCommand("mode","mode",t);var i=$(".mode").attr("data-mode");e.removeClass(i),e.attr("data-mode",t),["Home","Away","Night"].indexOf(t)>=0?($("#mode-name").hide(),e.addClass(t)):$("#mode-name").html(t).show()}),void $("#hello-home-popup li").on("click",function(){$("#hello-home-popup").popup("close"),animateClick($(".hello-home")),sendCommand("helloHome","helloHome",$(this).text())}))});var fadeOn=100,fadeOff=200,polling,wtfCloud=!1;nextPoll(30),refresh(3600),CoolClock.config.skins={st:{outerBorder:{lineWidth:12,radius:100,color:"yellow",alpha:0},smallIndicator:{lineWidth:16,startAt:80,endAt:85,color:"white",alpha:1},largeIndicator:{lineWidth:2,startAt:80,endAt:85,color:"white",alpha:1},hourHand:{lineWidth:8,startAt:0,endAt:60,color:"white",alpha:1},minuteHand:{lineWidth:6,startAt:0,endAt:75,color:"white",alpha:1},secondHand:{lineWidth:5,startAt:80,endAt:85,color:"red",alpha:0},secondDecoration:{lineWidth:3,startAt:96,radius:4,fillColor:"white",color:"black",alpha:1}},st1:{outerBorder:{lineWidth:2,radius:80,color:"white",alpha:0},smallIndicator:{lineWidth:5,startAt:88,endAt:94,color:"yellow",alpha:0},largeIndicator:{lineWidth:5,startAt:90,endAt:94,color:"white",alpha:1},hourHand:{lineWidth:8,startAt:0,endAt:60,color:"white",alpha:1},minuteHand:{lineWidth:8,startAt:0,endAt:80,color:"white",alpha:1},secondHand:{lineWidth:5,startAt:89,endAt:94,color:"white",alpha:1},secondDecoration:{lineWidth:3,startAt:0,radius:4,fillColor:"black",color:"black",alpha:0}}};var cellSize=getUrlParameter("t")||tileSize,cellGutter=getUrlParameter("g")||4;