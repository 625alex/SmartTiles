...
/*ActiON Dashboard*/
function animateClick(e){spinner(e);e.closest(".tile").animate({opacity:.3},fadeOff,"swing").delay(fadeOn).animate({opacity:1},fadeOn,"swing")}function spinner(e){e.closest(".tile").find(".spinner").fadeIn("slow").delay(2e3).fadeOut("slow")}function setIcons(){$(".switch").append("<div class='icon'>"+icons.switch.on+icons.switch.off+"</div>");$(".dimmer").append("<div class='icon'>"+icons.dimmer.on+icons.dimmer.off+"</div>");$(".light").append("<div class='icon'>"+icons.light.on+icons.light.off+"</div>");$(".holiday").append("<div class='icon'>"+icons.holiday.on+icons.holiday.off+"</div>");$(".lock").append("<div class='icon'>"+icons.lock.locked+icons.lock.unlocked+"</div>");$(".motion").append("<div class='icon'>"+icons.motion.active+icons.motion.inactive+"</div>");$(".presence").append("<div class='icon'>"+icons.presence.present+icons.presence.notPresent+"</div>");$(".contact").append("<div class='icon'>"+icons.contact.open+icons.contact.closed+"</div>");$(".water").append("<div class='icon'>"+icons.water.dry+icons.water.wet+"</div>");$(".dimmer, .music").each(function(){renderSlider($(this))});$(".weather").each(function(){renderWeather($(this))});$(".momentary").append("<div class='icon'>"+icons.momentary+"</div>");$(".camera").append("<div class='icon'>"+icons.camera+"</div>");$(".refresh").append("<div class='icon'>"+icons.refresh+"</div>");$(".hello-home").append("<div class='icon'>"+icons.helloHome+"</div>");$(".humidity").append("<div class='footer'>"+icons.humidity+"</div>");$(".temperature").append("<div class='footer'>"+icons.temperature+"</div>");$(".energy").append("<div class='footer'>"+icons.energy+"</div>");$(".power").append("<div class='footer'>"+icons.power+"</div>");$(".battery").append("<div class='footer'>"+icons.battery+"</div>");$(".link").find("a").html(icons.link);$(".dashboard").find("a").html(icons.dashboard);$(".tile[data-is-value=true]").each(function(){renderValue($(this))})}function renderSlider(e){e.find(".slider-container").remove();e.append("<div class='slider-container'><div class='full-width-slider'><input value='"+e.attr("data-level")+"' min='1' max='10' type='range' step='1' data-mini='true' data-popup-enabled='true' data-disabled='"+readOnlyMode+"' data-highlight='true'></div></div>").find("input").slider();$(".full-width-slider").click(function(e){e.stopImmediatePropagation()})}function renderValue(e){e.find(".icon").remove();e.append("<div class='icon text'>"+e.attr("data-value")+"</div>")}function renderWeather(e){var t=JSON.parse(e.attr("data-weather"));e.empty();var n="<div class='title'>"+e.attr("data-city")+"<br/><span class='title2'>"+t.weather+", feels like "+t.feelsLike+"&deg;</span></div>\n<div class='icon'><span class='text'>"+t.temperature+"&deg;</span><i class='wi "+t.icon+"'></i></span></div>\n<div class='footer'>"+t.localSunrise+" <i class='fa fa-fw wi wi-horizon-alt'></i> "+t.localSunset+"</div>\n<div class='footer right'>"+t.percentPrecip+"%<i class='fa fa-fw fa-umbrella'></i><br>"+t.humidity+"%<i class='fa fa-fw wi wi-sprinkles'></i></div>";e.html(n)}function sendCommand(e,t,n,r){var i=getUrlParameter("access_token");var s={type:e,device:t,command:n,value:r};if(i)s["access_token"]=i;$.get("command",s).done(function(e){if(e.status=="ok"){nextPoll(5)}}).fail(function(){setWTFCloud();nextPoll(10)})}function doPoll(e){nextPoll(20);if(!e)spinner($(".refresh"));var t=getUrlParameter("access_token");var n={ts:stateTS};if(t)n["access_token"]=t;$.get("ping",n).done(function(t){if(t.status=="refresh")refresh();clearWTFCloud();if(e){e()}else{stateTS=t.ts;$(".refresh .footer").html("Updated "+t.updated);if(t.status=="update"){for(i in t.data)updateTile(t.data[i])}}}).fail(function(){setWTFCloud()})}function updateTile(e){if(e.tile=="device"){var t=$("."+e.type+"[data-device="+e.device+"]");if(e.type=="music"){if(e.trackDescription!=t.attr("data-track-description")||e.mute+""!=t.attr("data-mute"))spinner(t);t.attr("data-track-description",e.trackDescription);if(e.mute+""!=t.attr("data-mute"))t.toggleClass("muted");t.attr("data-mute",e.mute);t.find(".title .track").html(t.attr("data-track-description"))}if(e.tile=="weather"){t.attr("data-weather",JSON.stringify(d));renderWeather(t)}else{if(e.value!=t.attr("data-value"))spinner(t);t.attr("data-value",e.value);if(e.isValue){renderValue(t)}else{t.removeClass("inactive active").addClass(e.active);t.attr("data-active",e.active)}if(e.type=="dimmer"||e.type=="music"){if(e.level!=t.attr("data-level"))spinner(t);t.attr("data-level",e.level);renderSlider(t)}}}else if(e.tile=="mode"){var t=$(".mode");if(e.mode!=t.attr("data-mode"))spinner(t);t.removeClass(t.attr("data-mode"));t.attr("data-mode",e.mode);if(e.isStandardMode)t.addClass(e.mode);$(".mode-name").html(e.mode)}}function setWTFCloud(){wtfCloud=true;$("#wtfcloud-popup").popup("open")}function clearWTFCloud(){wtfCloud=false;$("#wtfcloud-popup").popup("close")}function nextPoll(e){if(polling)clearInterval(polling);polling=setInterval(function(){doPoll()},e*1e3)}function refresh(e){if(!e){setTimeout(function(){doRefresh()},100)}else{setTimeout(function(){doRefresh()},e*1e3)}}function doRefresh(){doPoll(function(){$(".refresh .icon").addClass("fa-spin");location.reload()})}function getUrlParameter(e){var t=window.location.search.substring(1);var n=t.split("&");for(var r=0;r<n.length;r++){var i=n[r].split("=");if(i[0]==e){return i[1]}}}function startTime(){if(!document.getElementById("clock"))return;var e=new Date;var t=e.getHours();if(t>12){t=t-12}var n=e.getMinutes();var r=e.getSeconds();n=checkTime(n);r=checkTime(r);document.getElementById("clock").innerHTML=t+":"+n;setTimeout(function(){startTime()},500)}function checkTime(e){if(e<10){e="0"+e}return e}var scriptVersion="4.6.0";$(function(){$(".tile").append("<i class='spinner fa fa-refresh fa-spin'></i>");setIcons();$(".refresh, .clock").click(function(){refresh()});startTime();if(readOnlyMode){return false}$(".switch, .dimmer, .momentary, .clock, .lock, .link, .holiday, .camera, .music i, .light").click(function(){animateClick($(this))});$(".dashboard").click(function(e){animateClick($(this));e.stopImmediatePropagation();$(".refresh .icon").addClass("fa-spin");window.location=$(this).find("a").attr("href")});$(".switch, .light, .lock, .momentary, .holiday, .camera").click(function(){$(this).closest(".tile").toggleClass("active");sendCommand($(this).attr("data-type"),$(this).attr("data-device"),"toggle")});$(".dimmer").click(function(){$(this).toggleClass("active");sendCommand("dimmer",$(this).attr("data-device"),"toggle",$(this).attr("data-level"))});$(".dimmer").on("slidestop",function(e){var t=$(this).find("input").val();if($(this).hasClass("active")){animateClick($(this));sendCommand("dimmer",$(this).attr("data-device"),"level",t)}$(this).attr("data-level",t)});$(".music").on("slidestop",function(e){var t=$(this).find("input").val();animateClick($(this));sendCommand("music",$(this).attr("data-device"),"level",t);$(this).attr("data-level",t)});$(".music .play").click(function(){var e=$(this).closest(".tile");$(this).closest(".tile").toggleClass("active");sendCommand("music",e.attr("data-device"),"play")});$(".music .pause").click(function(){var e=$(this).closest(".tile");$(this).closest(".tile").toggleClass("active");sendCommand("music",e.attr("data-device"),"pause")});$(".music .muted").click(function(){var e=$(this).closest(".tile");$(this).closest(".tile").toggleClass("muted");sendCommand("music",e.attr("data-device"),"unmute")});$(".music .unmuted").click(function(){var e=$(this).closest(".tile");$(this).closest(".tile").toggleClass("muted");sendCommand("music",e.attr("data-device"),"mute")});$(".music .back").click(function(){var e=$(this).closest(".tile");sendCommand("music",e.attr("data-device"),"previousTrack")});$(".music .forward").click(function(){var e=$(this).closest(".tile");sendCommand("music",e.attr("data-device"),"nextTrack")});$(".mode, .hello-home, .thermostat").click(function(){$("#"+$(this).attr("data-popup")).popup("open")});$("#mode-popup li").click(function(){$("#mode-popup").popup("close");var e=$(".mode");animateClick(e);var t=$(this).text();sendCommand("mode","mode",t);var n=$(".mode").attr("data-mode");e.removeClass(n);e.attr("data-mode",t);if(["Home","Away","Night"].indexOf(t)>=0){$("#mode-name").hide();e.addClass(t)}else{$("#mode-name").html(t).show()}});$("#hello-home-popup li").on("click",function(){$("#hello-home-popup").popup("close");animateClick($(".hello-home"));sendCommand("helloHome","helloHome",$(this).text())})});var fadeOn=100;var fadeOff=200;var polling;var wtfCloud=false;nextPoll(30);refresh(60*60);CoolClock.config.skins={st:{outerBorder:{lineWidth:12,radius:100,color:"yellow",alpha:0},smallIndicator:{lineWidth:16,startAt:80,endAt:85,color:"white",alpha:1},largeIndicator:{lineWidth:2,startAt:80,endAt:85,color:"white",alpha:1},hourHand:{lineWidth:8,startAt:0,endAt:60,color:"white",alpha:1},minuteHand:{lineWidth:6,startAt:0,endAt:75,color:"white",alpha:1},secondHand:{lineWidth:5,startAt:80,endAt:85,color:"red",alpha:0},secondDecoration:{lineWidth:3,startAt:96,radius:4,fillColor:"white",color:"black",alpha:1}},st1:{outerBorder:{lineWidth:2,radius:80,color:"white",alpha:0},smallIndicator:{lineWidth:5,startAt:88,endAt:94,color:"yellow",alpha:0},largeIndicator:{lineWidth:5,startAt:90,endAt:94,color:"white",alpha:1},hourHand:{lineWidth:8,startAt:0,endAt:60,color:"white",alpha:1},minuteHand:{lineWidth:8,startAt:0,endAt:80,color:"white",alpha:1},secondHand:{lineWidth:5,startAt:89,endAt:94,color:"white",alpha:1},secondDecoration:{lineWidth:3,startAt:0,radius:4,fillColor:"black",color:"black",alpha:0}}};var cellSize=getUrlParameter("t")||tileSize;var cellGutter=getUrlParameter("g")||4